  ...
  return (
    <div>
        ...
        <div className='my-10 flex flex-col md:flex-row gap-12'>
          ...
          src={assets.about_image} alt="Error" />
          <div className='flex flex-col justify-center gap-4 md:w-2/4 text-sm text-gray-600'>
             <p>
              ...
              <h2 className='text-gray-800 font-bold'>Our Vision</h2>
        ...
        <div className='flex flex-col gap-2 md:flex-row mb-20'>
          <div className='border border-gray-300 rounded-lg  px-10 md:px-16 py-8 sm:py-16 flex flex-col gap-5 text-[15px] hover:bg-primary hover:border-black hover:text-white transition-all duration-300 text-gray-600 cursor-pointer'>
            <b>Efficiency:</b>
